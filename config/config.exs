...
config :my_ash_blog, MyAshBlogWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: MyAshBlogWeb.ErrorHTML, json: MyAshBlogWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: MyAshBlog.PubSub,
  live_view: [signing_salt: "1tF2Li5g"]
...
config :my_ash_blog, MyAshBlog.Mailer, adapter: Swoosh.Adapters.Local
